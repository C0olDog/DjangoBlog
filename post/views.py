...
def queryAll(request, page=1):
    ...
    currentPage = page
    return render(request, 'index.html', {"postList": perPageList, 'pageList': pageList, 'currentPage': currentPage})
